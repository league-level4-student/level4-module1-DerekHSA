...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Use WASD to move your snake. Make sure not to hit anything except food!";
	...
	private void setFoodLocation() {
		...
		Random r = new Random();
		Location loc = new Location(r.nextInt(15), r.nextInt(12));
	...
	private void gameOver() {
		...
		int input = JOptionPane.showOptionDialog(null, "Would you like to play again?", "Snake", 0, -1, null, options,
				0);
